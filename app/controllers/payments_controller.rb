class PaymentsController < ApplicationController
  ...
  HASH_KEY = "ESwFG2NOB2UDlrFRjyH3sJhmsIQnZ0tL"
  HASH_IV = "CbYGZSVNdlQIpM0P"

  def mpg
    merchantID = 'MS320704437'
    version = '1.6'
    respondType = 'JSON'
    ...
    data = "MerchantID=#{merchantID}&RespondType=#{respondType}&TimeStamp=#{timeStamp}&Version=#{version}&MerchantOrderNo=#{merchantOrderNo}&Amt=#{amt}&ItemDesc=#{itemDesc}&TradeLimit=300&Email=#{current_user.email}&CustomerURL=https://rails-fundraising.herokuapp.com/payments/not_paid_yet&ClientBackURL=https://rails-fundraising.herokuapp.com/payments/canceled"
